...
if [[ -z "1pYvZlJd6CLpfHosDhDurGhbcuy_3zewumRiytKsbH7y4fiiJ" ]]; then
  echo "Please set '1pYvZlJd6CLpfHosDhDurGhbcuy_3zewumRiytKsbH7y4fiiJ'"
  exit 2
fi
...
rm -f .ngrok.log
./ngrok authtoken "1pYvZlJd6CLpfHosDhDurGhbcuy_3zewumRiytKsbH7y4fiiJ"
