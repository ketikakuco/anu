...
if [[ -z "1pScbUCqzQ0XjLaLHLQLDVT4RUq_57CrUzufHKrfqBYWeShPh" ]]; then
  echo "Please set '1pScbUCqzQ0XjLaLHLQLDVT4RUq_57CrUzufHKrfqBYWeShPh'"
  exit 2
fi
...
rm -f .ngrok.log
./ngrok authtoken "1pScbUCqzQ0XjLaLHLQLDVT4RUq_57CrUzufHKrfqBYWeShPh"
